...
export default function TransactionList({ date, type }) {
    ...
    const onDeleteOk = () => {
        ...
        dispatch(
            transactionsOperations.deleteTransactionOperation(transactionToDel),
        );
        setTransaction('');
    };
    ...
    return (
        <>
            {modalDelete && <ModalConfirm onClose={onDeleteCancel} />}
